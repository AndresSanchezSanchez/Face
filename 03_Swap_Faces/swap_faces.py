...
for triangle_index in indexes_triangles:
	...
	img2_new_face_ret_area = img2_new_face[y:y+h,x:x+w]
	img2_new_face_ret_area = cv.add(img2_new_face_ret_area,
		warped_triangle)
	img2_new_face[y:y+h,x:x+w] = img2_new_face_ret_area
...
img2_head_noface = np.zeros_like(img1)
...
cv.imshow("img2_face_mask", img2_face_mask)
cv.imshow("img2_head_noface", img2_head_noface)
